...
public class ServerSteps {
	...
	public void AppendFilesToTempFile(String fileName,String dirname) {
		int i=1;
		while(i<=5) {
	...
	public void DownloadTempFile(String fileName) {
	...
	public void PrintContentOfTempFile(String fileName) {
